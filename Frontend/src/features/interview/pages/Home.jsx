...
import NormalLoadingScreen from './NormalLoadingScreen'
                                ...
                                <label className='dropzone' htmlFor='resume' style={resumeFile ? { borderColor: '#22c55e', background: '#202940' } : {}}>
                                    {resumeFile ? (
                                        ...
                                        <>
                                            ...
                                            <p className='dropzone__title' style={{ color: '#16a34a', fontWeight: 600 }}>
                                                {resumeFile.name}
                                            </p>
                                            <p className='dropzone__subtitle' style={{ color: '#4ade80' }}>
                                                {(resumeFile.size / 1024).toFixed(1)} KB &bull; Uploaded successfully
                                            </p>
                                            <button
